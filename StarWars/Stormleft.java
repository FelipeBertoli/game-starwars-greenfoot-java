...
/**
 * The Stormleft class represents a Stormtrooper that movesright
 ...
 * @version 1.0
 */
public class Stormleft extends Stormtrooper
{
    /**
     ...
     * */
    public Stormleft(int gameMode) {
        super(gameMode);
        stand = new GreenfootImage("stormstand2.png");
        walk = new GreenfootImage("stormwalk2.png");
        damaged = new GreenfootImage("stormdano2.png");
    ...
    /**
     * The walk() method moves the Stormtrooper to the right until it reaches its destination. When it reaches the destination,
